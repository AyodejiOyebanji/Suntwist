  ...
  <div class="container-fluid">
      ...
      < FaOpencart size="20px" className='bsPeoplesmall'/> 
        ...
        <React.Fragment key={anchor}>
          <Button onClick={toggleDrawer(anchor, true)}><AiOutlineMenu size="20px"/></Button>
          <Drawer
            anchor={anchor}
            open={state[anchor]}
   ...
   {/* toogle ends */}
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      autoComplete="off"
    >
      <TextField id="outlined-basic" className='outlined-basic ' label="Search Product" variant="outlined"
       />
      ...
      <Button variant="outlined" className='search' > <IoSearchOutline/></Button>
